...
# LINKS / CANALES
# =========================
WEBSITE_URL = "https://vortexggshop.mysellauth.com/"
VOUCHES_CHANNEL_ID = 1434701785284739224

# =========================
# SELLAUTH CONFIG
# =========================
SELLAUTH_API_KEY  = ""    # <- Pegá tu API Key de SellAuth acá
SELLAUTH_SHOP_ID  = ""    # <- Pegá tu Shop ID de SellAuth acá
SELLAUTH_BASE_URL = ""
SALES_LOG_CHANNEL_NAME = "📦┃ventas-logs"
RESTOCK_CHANNEL_NAME  = "📦┃stock"        # Canal donde se postean los restocks
RESTOCK_POLL_MINUTES  = 1                  # Cada cuántos minutos revisa el stock
...
async def agregarproductos(interaction: discord.Interaction):
    ...
    if sa_data is None:
        return await interaction.followup.send(
            ...
            "Verificá `SELLAUTH_API_KEY` y `SELLAUTH_SHOP_ID` en el código.",
            ephemeral=True,
        )
